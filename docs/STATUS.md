...
event/schema support; a private descriptor-relative local checkpoint store; and
bounded serial replay over explicitly ordered immutable archive manifests.
