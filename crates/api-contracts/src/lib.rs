...
pub use v1_1::{
    ...
    WireVaultLeaderCommissionPaid, decode_account_class_transfer, decode_internal_transfer,
    decode_non_user_order_cancelled, decode_reward_claimed, decode_spot_genesis_applied,
    decode_staking_delegated, decode_staking_deposit, decode_staking_undelegated,
    decode_staking_withdrawal_completed, decode_staking_withdrawal_queued,
    decode_validator_reward_paid, decode_vault_created, decode_vault_distribution,
    decode_vault_leader_commission_paid, encode_account_class_transfer, encode_canonical_snapshot,
